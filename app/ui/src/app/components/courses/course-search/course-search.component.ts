...
@Component({
  ...
  standalone: true,
  imports: [FooterComponent,CourseNavbarComponent,RouterLink,TruncateStringSizePipe,CommonModule,CourseCardComponent],
...
export class CourseSearchComponent {
  ...
  ngOnInit(){
    this.courseService.getCourses().subscribe({
      next: (value) =>{this.courses=value;this.AllCourses=[...value]},
      error: (err) => console.error('Observable emitted an error: ' + err),
      complete: () =>{}
    });
  }

  searchInputCall(value:any)
  {
